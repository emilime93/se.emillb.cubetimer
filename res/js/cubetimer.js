...
class Storage {
  ...
  */
  ...
  /**
   * @returns The JSON object with preference:value for the preferences
   */
  ...
  /**
   * Saves the user preferences to the localstorage
   * @param {Object} prefs The JSON object of preference:value members
   */
